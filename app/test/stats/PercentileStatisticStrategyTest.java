...
import app.src.stats.PercentileStatisticStrategy;

import jspec.*;

public class PercentileStatisticStrategyTest extends SpecModule {
    private Course course;

    public void spec_code() {
        describe("PercentileStatisticStrategy", () -> {
            before(() -> {
            ...
            it("creates a PercentileStatisticStrategy object", () -> {
                PercentileStatisticStrategy percentile = new PercentileStatisticStrategy(this.course);
                assert_that(percentile).isnot(null);
            });

            it("calculates the percentile statistic out of a set of latest grades", () -> {
                PercentileStatisticStrategy percentile = new PercentileStatisticStrategy(this.course);
